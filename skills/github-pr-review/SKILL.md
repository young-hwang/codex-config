...
description: "Migrate and run the workflow from Claude command github/pr-review.md. Use when asked to perform tasks matching github-pr-review, for example: **PR Link/Number**: $ARGUMENTS"
---
...
Use this skill to execute the existing workflow migrated from `github/pr-review.md`.
