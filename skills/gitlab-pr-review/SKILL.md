...
description: "Migrate and run the workflow from Claude command gitlab/pr-review.md. Use when asked to perform tasks matching gitlab-pr-review, for example: **PR Link/Number**: $ARGUMENTS"
---
...
Use this skill to execute the existing workflow migrated from `gitlab/pr-review.md`.
...
> **Instructions**: Execute each task in the order given to conduct a thorough code review.  Update Gitlab with this review.
