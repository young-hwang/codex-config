---
name: "tdd"
description: "Apply test-driven development workflow. Use when asked to implement features via Red-Green-Refactor cycles, write failing tests first, and keep implementation minimal and verified."
---
...
Use this skill to execute the existing workflow migrated from `tdd.md`.
